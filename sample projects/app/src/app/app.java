...
public class app extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Login", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Swis721 LtEx BT", 1, 14), new java.awt.Color(4, 213, 4))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String UN = "Ghaith" ;
        String UP = "g2001zaza";
        String NUN= UserName.getText();
        String NUP= String.valueOf(UserPass.getPassword());
        if (UN.equals(NUN)&&UP.equals(NUP)) {
            dispose();
            new Welcome().setVisible(true);
        }
        else {
            JOptionPane.showMessageDialog(null, "the User or the password is incorrect");
        }        
